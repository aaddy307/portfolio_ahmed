...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <div className="cursor-dot fixed top-0 left-0 z-[99999] h-2 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-accent-primary to-accent-secondary pointer-events-none mix-blend-difference" />
