  ...
  return (
    ...
    >
      ...
      <div className="w-full min-h-full flex items-center justify-center py-8">
        <div className="modal-content p-5 sm:p-6 lg:p-8 max-w-3xl w-full my-auto relative bg-gradient-to-br from-background-secondary/95 to-background-primary/95 rounded-2xl shadow-2xl border border-white/10 backdrop-blur-md">
          {/* Header - Responsive */}
          <div className="flex justify-between items-start gap-4 mb-5 sm:mb-6">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold gradient-text flex-1 pr-2 break-words">
              {project.title}
            </h3>
            <button
              onClick={onClose}
              className="text-2xl sm:text-3xl hover:text-accent-primary transition-all hover:rotate-90 duration-300 flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full hover:bg-white/10"
            ...
            <div className="mb-5 sm:mb-6 lg:mb-8">
              ...
              <ul className="space-y-2 sm:space-y-2.5 lg:space-y-3">
                {project.features.map((feature, index) => (
                  ...
                  >
                    <i className="fas fa-check-circle text-orange-500 mt-0.5 sm:mt-1 flex-shrink-0 group-hover:scale-110 transition-transform"></i>
